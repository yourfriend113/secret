...
local function adjustCanvasSize()
    ...
    local newCanvasSizeY = numLogs * UIGridLayout_7.CellSize.Y.Offset
...
if game.PlaceId == 17033012939 then
	local teleportData = {
		{button = Gui.Absolute, part = game:GetService("Workspace"):FindFirstChild("tpω")},
		{button = Gui.Abyss, part = game:GetService("Workspace"):FindFirstChild("TpVoid2")},
		{button = Gui.Killstreak, part = game:GetService("Workspace"):FindFirstChild("Tp1")},
		{button = Gui.RWE, part = game:GetService("Workspace"):FindFirstChild("Tprwe")},
		{button = Gui.Radioactive, part = game:GetService("Workspace"):FindFirstChild("Tp20")},
		{button = Gui.Reaper, part = game:GetService("Workspace"):FindFirstChild("Tp8")},
		{button = Gui.Luminary, part = game:GetService("Workspace"):FindFirstChild("Tp18")},
		{button = Gui.Cultivator, part = game:GetService("Workspace"):FindFirstChild("Tp26")},
		{button = Gui.Oceanic, part = game:GetService("Workspace"):FindFirstChild("Tp51")},
		{button = Gui.Glass, part = game:GetService("Workspace"):FindFirstChild("Tp55")},
		{button = Gui.Dazzling, part = game:GetService("Workspace"):FindFirstChild("Tp10")},
		{button = Gui.Overheat, part = game:GetService("Workspace"):FindFirstChild("Tp14")},
		{button = Gui.Glitch, part = game:GetService("Workspace"):FindFirstChild("Tp12")},
		{button = Gui.ERroR, part = game:GetService("Workspace"):FindFirstChild("TpErr2")},
		{button = Gui.Antimatter, part = game:GetService("Workspace"):FindFirstChild("Tpanti")},
		{button = Gui.Trihampter, part = game:GetService("Workspace"):FindFirstChild("Tphug2")},
		{button = Gui.Amogus, part = game:GetService("Workspace"):FindFirstChild("Tp28")},
		{button = Gui.Rupture, part = game:GetService("Workspace"):FindFirstChild("Tp24")},
		{button = Gui.Hampter, part = game:GetService("Workspace"):FindFirstChild("Tp6")},
		{button = Gui.Godly, part = game:GetService("Workspace"):FindFirstChild("Tp22")},
		{button = Gui.Equinox, part = game:GetService("Workspace"):FindFirstChild("Tp750")},
		{button = Gui.Fish, part = game:GetService("Workspace"):FindFirstChild("Tp30")},
		{button = Gui.OpFish, part = game:GetService("Workspace"):FindFirstChild("Tp32")},
		{button = Gui.VoidFish, part = game:GetService("Workspace"):FindFirstChild("Tp34")},
		{button = Gui.CS, part = game:GetService("Workspace"):FindFirstChild("Tp65")},
		{button = Gui.Noobstreak, part = game:GetService("Workspace"):FindFirstChild("Tp53")},
		{button = Gui.Moneystreak, part = game:GetService("Workspace"):FindFirstChild("TpMoney")},
		{button = Gui.Lobotomy, part = game:GetService("Workspace"):FindFirstChild("lobotomytp")},
		{button = Gui.Trojan, part = game:GetService("Workspace"):FindFirstChild("Tp61")},
		{button = Gui.Infinity, part = game:GetService("Workspace"):FindFirstChild("Tp43")},
		{button = Gui.Celebration, part = game:GetService("Workspace"):FindFirstChild("Tp41")},
		{button = Gui.Frozen, part = game:GetService("Workspace"):FindFirstChild("Tpfreeze")},
		{button = Gui.Maxdesignpro, part = game:GetService("Workspace"):FindFirstChild("Tpmax")},
		{button = Gui.Jimmypro, part = game:GetService("Workspace"):FindFirstChild("Tpjim")},
		{button = Gui.Tiem, part = game:GetService("Workspace"):FindFirstChild("Tp57")},
		{button = Gui.RAD, part = game:GetService("Workspace"):FindFirstChild("RADtp")},
		{button = Gui.Blackhole, part = game:GetService("Workspace"):FindFirstChild("tpblackhole2")},
		{button = Gui.RMP, part = game:GetService("Workspace"):FindFirstChild("RMPtp")},
		{button = Gui.Grinder, part = game:GetService("Workspace"):FindFirstChild("Tpgrind")},
		{button = Gui.Hugeks, part = game:GetService("Workspace"):FindFirstChild("Tphuge")},
		{button = Gui.Rng, part = game:GetService("Workspace"):FindFirstChild("Tprng")},
		{button = Gui.Ommetaphobia, part = game:GetService("Workspace"):FindFirstChild("Ommetaphobiatp")},
		{button = Gui.Obliterator, part = game:GetService("Workspace"):FindFirstChild("Tpobliterator")},
		{button = Gui.Solar, part = game:GetService("Workspace"):FindFirstChild("solartp")},
		{button = Gui.Extended, part = game:GetService("Workspace"):FindFirstChild("Tpextended")},
		{button = Gui.GoldenCS, part = game:GetService("Workspace"):FindFirstChild("Tpgoldencs")},
		{button = Gui.Supercelebration, part = game:GetService("Workspace"):FindFirstChild("Supertp")},
		{button = Gui.DEX, part = game:GetService("Workspace"):FindFirstChild("tpDEX")},
		{button = Gui.Opks, part = game:GetService("Workspace"):FindFirstChild("Tpopks2")},
		{button = Gui.Insanity, part = game:GetService("Workspace"):FindFirstChild("Tpinsaneness")},
		{button = Gui.Truecultivator, part = game:GetService("Workspace"):FindFirstChild("Tptruecult")},
		{button = Gui.Paradox, part = game:GetService("Workspace"):FindFirstChild("tpparadox")},
		{button = Gui.Observer, part = game:GetService("Workspace"):FindFirstChild("tpobserver")},
		{button = Gui.Infiniplex, part = game:GetService("Workspace"):FindFirstChild("Tpinfiniplex")},
		{button = Gui.Titanium, part = game:GetService("Workspace"):FindFirstChild("tptitanium")},
		{button = Gui.TrueStreak, part = game:GetService("Workspace"):FindFirstChild("tptrue")},
		{button = Gui.Electro, part = game:GetService("Workspace"):FindFirstChild("Tpelectro")},
		{button = Gui.Kilstek, part = game:GetService("Workspace"):FindFirstChild("Tpjoke")},
		{button = Gui.VoidCS, part = game:GetService("Workspace"):FindFirstChild("Tpvoidcs")},
		{button = Gui.AquamarineCS, part = game:GetService("Workspace"):FindFirstChild("Tpaquacs")},
		{button = Gui.SadReaper, part = game:GetService("Workspace"):FindFirstChild("sadreapertp")},
		{button = Gui.Defender, part = game:GetService("Workspace"):FindFirstChild("defendertp")},
		{button = Gui.RUWU, part = game:GetService("Workspace"):FindFirstChild("ruwutp")},
		{button = Gui.TimeGod, part = game:GetService("Workspace"):FindFirstChild("Tptimegod")},
		{button = Gui.Wawa, part = game:GetService("Workspace"):FindFirstChild("Tpwawa")},
		{button = Gui.Incinerator, part = game:GetService("Workspace"):FindFirstChild("Tpincinerator")},
		{button = Gui.Prima, part = game:GetService("Workspace"):FindFirstChild("TpPrima")},
		{button = Gui.Grinderx, part = game:GetService("Workspace"):FindFirstChild("Tpgrindx")},
